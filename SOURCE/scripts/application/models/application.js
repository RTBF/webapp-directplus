...
define(['application/config', 'application/routes/router', 'application/models/slide', 'application/collections/slides', 'application/views/appView', 'vendors/socketio/socketio'], function(Config, Router, Slide, SlidesList, AppView) {
  /*
